...
module.exports = function (config) {
    config.set({
        ...
        files: [            
            ...
            '../catchme.webui/Assets/Scripts/app/catchMe.app.js',
            '../catchme.webui/Assets/Scripts/app/catchMe.routes.js',
            '../catchme.webui/Assets/Scripts/app/catchMe.constants.js',
            '../catchme.webui/Assets/Scripts/app/catchMe.material.js',
            '../catchme.webui/Assets/Scripts/app/services/trip.service.js',
            '../catchme.webui/Assets/Scripts/app/services/googleMap.service.js',
            '../catchme.webui/Assets/Scripts/app/controllers/tripList.controller.js',
            '../catchme.webui/Assets/Scripts/app/controllers/tripAdd.controller.js',
            '../catchme.webui/Assets/Scripts/app/controllers/partialDrawerMenu.controller.js',
            '../catchme.webui/Assets/Scripts/app/components/hoverClass.directive.js',
            'services/*.js',
            'configs/*.js'
        ],
