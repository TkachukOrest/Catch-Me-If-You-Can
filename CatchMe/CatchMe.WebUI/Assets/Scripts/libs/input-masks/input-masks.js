        ...
        .directive('uiMoneyMask', ['$locale', '$parse', function ($locale, $parse) {
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    var decimalDelimiter = $locale.NUMBER_FORMATS.DECIMAL_SEP,
                        thousandsDelimiter =  $locale.NUMBER_FORMATS.GROUP_SEP,                        
                        currencySym = attrs.currencySymbol ? attrs.currencySymbol : $locale.NUMBER_FORMATS.CURRENCY_SYM,
                    ...
                    var maskPattern = '#' +  thousandsDelimiter + '##0' + decimalsPattern + ' ' + currencySym;
                    ...
                    if (attrs.uiMoneyMask) {
                        scope.$watch(attrs.uiMoneyMask, function (decimals) {
                            ...
                            maskPattern = '#' + thousandsDelimiter + '##0' + decimalsPattern + ' ' + currencySym;
